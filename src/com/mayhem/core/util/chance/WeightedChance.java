...
public class WeightedChance<T> implements WeightedObject<T> {
	...
	public static final double COMMON = 6.5;
	public static final double UNCOMMON = 3.0;
	public static final double RARE = 1.5;
	public static final double VERY_RARE = .35;
	public static final double LEGENDARY = 0.10;//0.50% Chance?
