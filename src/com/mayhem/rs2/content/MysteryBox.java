...
public class MysteryBox {
	...
	public static Chance<Item> LOOTS = new Chance<Item>(Arrays.asList(
			...
			//Rare Items
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4753, 1)), //Verac's helm 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4755, 1)), //Verac's flail 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4759, 1)), //Verac's plateskirt 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4757, 1)), //Verac's brassard 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4745, 1)), //Torag's helm 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4747, 1)), //Torag's hammers 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4749, 1)), //Torag's platebody 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4751, 1)), //Torag's platelegs 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4732, 1)), //Karil's coif 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4734, 1)), //Karil's crossbow 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4736, 1)), //Karil's leathertop 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4738, 1)), //Karil's leatherskirt 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4724, 1)), //Guthan's helm 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4726, 1)), //Guthan's warspear 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4728, 1)), //Guthan's platebody 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4730, 1)), //Guthan's chainskirt 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4708, 1)), //Ahrim's hood 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4710, 1)), //Ahrim's staff 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4712, 1)), //Ahrim's robetop 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4714, 1)), //Ahrim's robeskirt 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4716, 1)), //Dharok's helm 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4718, 1)), //Dharok's greataxe 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4720, 1)), //Dharok's platebody 
			new WeightedChance<Item>(WeightedChance.RARE, new Item(4722, 1)), //Dharok's platelegs 
			...
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(13343, 1)),//black santa
			new WeightedChance<Item>(WeightedChance.VERY_RARE, new Item(13344, 1)),//inverse santa
