...
import com.mayhem.rs2.content.minigames.pestcontrol.monsters.Portal;
...
import com.mayhem.rs2.content.minigames.pestcontrol.monsters.Splatter;
...
public class PestControlConstants {
	 ...
	 */
	public static final Location[] PORTAL_SPAWN_LOCATIONS = { new Location(2628, 2591, 0), new Location(2680, 2588, 0), new Location(2669, 2570, 0), new Location(2645, 2569, 0), };
