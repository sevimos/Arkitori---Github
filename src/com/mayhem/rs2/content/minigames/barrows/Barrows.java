package com.mayhem.rs2.content.minigames.barrows;
...
import com.mayhem.rs2.content.TeleportHandler.TeleportationData;
...
import com.mayhem.rs2.entity.following.Following.FollowType;
import com.mayhem.rs2.entity.item.Item;
import com.mayhem.rs2.entity.mob.Mob;
import com.mayhem.rs2.entity.player.Player;
import com.mayhem.rs2.entity.player.net.out.impl.SendMessage;
import com.mayhem.rs2.entity.player.net.out.impl.SendPlayerHint;
...
public class Barrows {
	...
	private static final Item[] JUNK_ITEM = {new Item(3052, 10),new Item(208, 10),new Item(200, 50),new Item(1437, 250),new Item(1333, 1), new Item(1303, 1),new Item(1201, 1),new Item(1185, 1),new Item(1163, 1),new Item(1147, 1),new Item(1127, 1),new Item(1113, 1),new Item(1093, 1),new Item(1079, 1),new Item(892, 200), new Item(4740, 5), new Item(4740, 15), new Item(4740, 75), new Item(4740, 55), new Item(4740, 25), new Item(4740, 15), new Item(592), new Item(526), new Item(533, 150), new Item(554, 75), new Item(555, 75), new Item(556, 75), new Item(557, 75), new Item(558, 75), new Item(559, 75) };

	/** The items considered relatively hard to get. */
	private static final Item[] HARD_ITEM = {new Item(19484, 50),new Item(11212, 100),new Item(3052, 150),new Item(208, 150),new Item(200, 250),new Item(9075, 500),new Item(2621, 1),new Item(2619, 1),new Item(2617, 1),new Item(2615, 1), new Item(4740, 50), new Item(4740, 150), new Item(4740, 750), new Item(4740, 550), new Item(4740, 205), new Item(4740, 105), new Item(534, 200), new Item(562, 250), new Item(560, 250), new Item(561, 250), new Item(565, 250), new Item(566, 250) };
...
//	private static final Item[] RARE_ITEM = { new Item(4708), new Item(4710), new Item(4712), new Item(4714), new Item(4716), new Item(4718), new Item(4720), new Item(4722), new Item(4724), new Item(4726), new Item(4728), new Item(4730), new Item(4732), new Item(4734), new Item(4736), new Item(4738), new Item(4745), new Item(4749), new Item(4751), new Item(4753), new Item(4755), new Item(4757), new Item(4759) };
	...
	public static boolean teleportPlayer(Player player) {
		for (Brother brother : Brother.values()) {
			if (player.getLocation().inLocation(brother.getSouthWest(), brother.getNorthEast(), true)) {
				player.send(new SendMessage("You need to slay " + brother.name().toLowerCase() + " at the chest near the entrance!"));
	...
	public static void summon(final Brother brother, final Player player) {
		...
		player.getBrotherNpc().getFollowing().setFollow(player, FollowType.COMBAT);
	...
	public static boolean clickObject(Player player, int id, int x, int y, int z) {
		...
		case 20973:
			if (player.getBarrowsKC() == 6) {
				...
				player.teleport(TeleportationData.BARROWS.getPosition());
