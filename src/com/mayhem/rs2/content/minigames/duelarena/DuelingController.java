...
public class DuelingController extends Controller {
	...
	public Location getRespawnLocation(Player player) {
		Location p = DuelingConstants.RESPAWN_LOCATIONS[com.mayhem.core.util.Utility.randomNumber(DuelingConstants.RESPAWN_LOCATIONS.length)];
		int[] dir = com.mayhem.rs2.GameConstants.DIR[com.mayhem.core.util.Utility.randomNumber(com.mayhem.rs2.GameConstants.DIR.length)];
