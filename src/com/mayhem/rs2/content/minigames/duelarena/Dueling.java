package com.mayhem.rs2.content.minigames.duelarena;
...
import com.mayhem.rs2.entity.player.net.out.impl.SendDuelEquipment;
...
public class Dueling {
	...
	public void onVictory() {
		...
		if (toReturn.intValue() >= 10_000_000) {
			...
			AchievementHandler.activate(p, AchievementList.WIN_A_DUEL_WORTH_OVER_10M, 1);
		}
		p.getInventory().update();
		AchievementHandler.activate(p, AchievementList.WIN_20_DUELS, 1);
	}
