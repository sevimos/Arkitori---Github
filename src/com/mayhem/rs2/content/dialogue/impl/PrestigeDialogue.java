...
public class PrestigeDialogue extends Dialogue {
	...
	public void execute() {
		switch(next) {
		case 0:
			DialogueManager.sendNpcChat(player, 3215, Emotion.HAPPY, "Hello "+player.getUsername()+".", "I am the prestige master.", "How may I help you?");
			next++;
			break;
		case 1:
			...
			break;
		case 5:
			DialogueManager.sendNpcChat(player, 3215, Emotion.HAPPY, "The prestiging system is quite simple.");
			next ++;
			break;
		case 6:
			DialogueManager.sendNpcChat(player, 3215, Emotion.HAPPY, "When you have reached the level 99 in any skill", "you will have the ability to Prestige it.");
			next ++;
			break;
		case 7:
			DialogueManager.sendNpcChat(player, 3215, Emotion.HAPPY, "By doing so you will reset your experience to 0.", "In return you will be rewarded with coins as well as your", "skill being a different color representing the prestige level.");
			setNext(1);
			break;
		}
	}
