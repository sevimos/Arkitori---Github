...
public class ShopExchangeDialogue2 extends Dialogue {
	...
	public boolean clickButton(int button) {
		...
		case DialogueConstants.OPTIONS_3_2:
			if (player.getCredits() < 10) {
				DialogueManager.sendStatement(player, "You do not have enough Arkitori Credits to do this!");
				return false;
			}
	...
	public void execute() {
		switch (next) {
		case 0:
			DialogueManager.sendOption(player, "Edit shop", "Edit shop motto (10 Arkitori Credits)", "Edit shop color (10 Arkitori Credits)");
			break;
		}
	}
