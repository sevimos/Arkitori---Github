...
public class NeiveDialogue extends Dialogue {
	...
	public boolean clickButton(int id) {
		...
		case DialogueConstants.OPTIONS_3_1:
			if (!player.getInventory().hasItemAmount(995, 500_000)) {
	...
	public void execute() {
		...
		case 0:
			DialogueManager.sendNpcChat(player, 490, Emotion.DEFAULT, "Hello my elite friend.", "I can give you a boss task.", "It will cost you 250,000 coins.", "Are you interested?");
			next ++;
			break;
