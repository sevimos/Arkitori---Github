...
public class VannakaDialogue extends Dialogue {
	...
	public void execute() {
		...
		case 0:
			...
			break;
		case 1:
			DialogueManager.sendOption(player, "Obtain task", "Set co-op slayer partner", "Reset my task (@red@250k@bla@)", "Trade");
			break;
		case 2:
		...
		case 5:
			...
			break;
		case 7:
			DialogueManager.sendOption(player, "Normal Slayer", "@blu@Boss Slayer");
			break;
		case 6:
