package com.mayhem.rs2.content.sounds;

import com.mayhem.core.util.GameDefinitionLoader;
import com.mayhem.rs2.entity.Sound;
...
public class PlayerSounds {
	...
	public static void sendBlockOrHitSound(Player player, boolean hit) {
		...
		if ((shield != null) && (sounds[shield.getId()] != null)) {
			player.getClient().queueOutgoingPacket(new SendSound(sounds[shield.getId()][com.mayhem.core.util.Utility.randomNumber(sounds[shield.getId()].length)].id, 0, 0));
		}
