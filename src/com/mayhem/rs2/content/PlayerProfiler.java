...
public class PlayerProfiler {
	...
	public static void displayProfile(Player player, Player viewing) {
		...
		player.send(new SendString("</col>Arkitori Credits: @whi@" + viewing.getCredits(), 51885));
	...
	public static void myProfile(Player player) {
		...
		player.send(new SendString("</col>Arkitori Credits: @whi@" + player.getCredits(), 51686));
