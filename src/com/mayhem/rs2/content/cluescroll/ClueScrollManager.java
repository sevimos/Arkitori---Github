package com.mayhem.rs2.content.cluescroll;
...
import com.mayhem.rs2.content.Emotes.Emote;
import com.mayhem.rs2.content.cluescroll.Clue.ClueType;
import com.mayhem.rs2.content.cluescroll.scroll.EmoteScroll;
import com.mayhem.rs2.content.cluescroll.scroll.MapScroll;
...
public enum ClueScrollManager {
	...
	public static void declare() {
		...
		CROSS_TRAILS.add(5, new Item(19994)); // ranger gloves
		CROSS_TRAILS.add(5, new Item(7914)); // german shepard pet
		CROSS_TRAILS.add(10, new Item(9952)); // Pet imp
		...
		EASY.add(20, new Item(20205, 1)); // gilded chef hat
		EASY.add(20, new Item(20199, 1)); // monk top (g)
		EASY.add(20, new Item(20202, 1)); // monk bottoms (g)
		EASY.add(20, new Item(20208, 1)); //gilded chef apron
		...
		MEDIUM.add(20, new Item(20240, 1)); // crier coat
		MEDIUM.add(20, new Item(12319, 1)); // crier hat
		MEDIUM.add(20, new Item(20249, 1)); // clueless cluescroll
		...
		HARD.add(10, new Item(20014, 1)); // 3rd age pickaxe
		HARD.add(10, new Item(20011, 1)); // 3rd age axe
		HARD.add(10, new Item(19687, 1)); // clue hunter
		HARD.add(10, new Item(19697, 1)); // clue hunter
		HARD.add(10, new Item(19689, 1)); // clue hunter
		HARD.add(10, new Item(19693, 1)); // clue hunter
		HARD.add(10, new Item(19695, 1)); // clue hunter
		HARD.add(10, new Item(19691, 1)); // clue hunter
		...
		/* Map Scrolls - Easy */
		CLUE_SCROLLS.put(2682, new MapScroll(2682, ClueDifficulty.EASY, new Location(3289, 3374, 0), 7045));
		CLUE_SCROLLS.put(2683, new MapScroll(2683, ClueDifficulty.EASY, new Location(3091, 3226, 0), 7113));
		CLUE_SCROLLS.put(2684, new MapScroll(2684, ClueDifficulty.EASY, new Location(2702, 3428, 0), 7162));
		CLUE_SCROLLS.put(2685, new MapScroll(2685, ClueDifficulty.EASY, new Location(2971, 3415, 0), 17537));
