...
public class SuperHeat extends Spell {
	...
	public boolean execute(Player player) {	
	   ...
	   AchievementHandler.activate(player, AchievementList.USE_THE_SUPER_HEATING_SPELL_25_TIMES, 1);
	   AchievementHandler.activate(player, AchievementList.USE_THE_SUPER_HEATING_SPELL_135_TIMES, 1);
	   return true;
	}
