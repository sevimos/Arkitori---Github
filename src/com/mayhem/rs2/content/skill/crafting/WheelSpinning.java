...
public class WheelSpinning extends ProductionTask {
	...
	public String getInsufficentLevelMessage() {
		return "You need a " + Skills.SKILL_NAMES[getSkill()] + " level of " + getRequiredLevel() + " to spin " + GameDefinitionLoader.getItemDef(spinnable.getOutcome().getId()).getName().toLowerCase() + ".";
	}
