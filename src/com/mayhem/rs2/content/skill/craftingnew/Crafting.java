package com.mayhem.rs2.content.skill.craftingnew;
		...
		TaskQueue.queue(new Task(player, 2, true, StackType.NEVER_STACK, BreakType.ON_MOVE, TaskIdentifier.SKILL_CREATING) {
			...
			public void execute() {
				...
				if (craftable.getName() == "Gem") {
					AchievementHandler.activate(player, AchievementList.CUT_250_GEMS, 1);
					player.skillPoints += (10 + Utility.random(15));
				}
