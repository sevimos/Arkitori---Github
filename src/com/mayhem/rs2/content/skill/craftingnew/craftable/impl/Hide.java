package com.mayhem.rs2.content.skill.craftingnew.craftable.impl;

import com.mayhem.rs2.content.skill.craftingnew.Crafting;
import com.mayhem.rs2.content.skill.craftingnew.craftable.Craftable;
import com.mayhem.rs2.content.skill.craftingnew.craftable.CraftableItem;
...
public enum Hide implements Craftable {
	...
	SNAKESIN(new Item(1733), new Item(6289),
			new CraftableItem(new Item(6322), new Item(6289, 15), 53, 3 + 2/3.0),
			new CraftableItem(new Item(6324), new Item(6289, 12), 51, 4 + 1/6.0),
			new CraftableItem(new Item(6330), new Item(6289, 8), 45, 4 + 3/8.0),
			new CraftableItem(new Item(6326), new Item(6289, 5), 48, 9.0),
			new CraftableItem(new Item(6328), new Item(6289, 6), 45, 5.0)),
