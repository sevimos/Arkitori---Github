package com.mayhem.rs2.content.skill.agility;
...
import com.mayhem.rs2.content.skill.agility.obstacle.ObstacleType;
...
//		 .build());
	...
	public boolean fireObjectClick(Player player, Location location, GameObject gameObject) {
		...
		if (obstacle.getType() == ObstacleType.ROPE_SWING) {
			player.getAttributes().set("AGILITY_OBJ", gameObject);
		}
