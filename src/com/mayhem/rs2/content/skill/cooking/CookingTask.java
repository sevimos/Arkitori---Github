...
public class CookingTask extends Task {
	...
	private void cookFood() {
		...
		player.getClient().queueOutgoingPacket(new SendMessage("You successfully cook the " + Item.getDefinition(used).getName() + ". You now have @blu@" + player.skillPoints + "</col> Skill points."));
