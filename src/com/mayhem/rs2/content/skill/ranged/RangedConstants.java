...
public class RangedConstants {
	...
	public static final int DARK_BOW_GREEN__ID = 12765;
	public static final int DARK_BOW_BLUE_ID = 12766;
	public static final int DARK_BOW_YELLOW_ID = 12767;
	public static final int DARK_BOW_WHITE_ID = 12768;
	...
	public static final int DRAGON_ARROW_GRAPHIC = 1122;
	...
	public static Graphic getDrawbackGraphic(Player player) {
		...
		case SHOT:
			...
			if (weapon.getId() == 12765) {
				return data.getDrawback2();
			}
			if (weapon.getId() == 12766) {
				return data.getDrawback2();
			}
			if (weapon.getId() == 12767) {
				return data.getDrawback2();
			}
			if (weapon.getId() == 12768) {
				return data.getDrawback2();
			}
			if (weapon.getId() == 20408) {
				return data.getDrawback2();
			}
			if (weapon.getId() == 20997) {
				return data.getDrawback2();
			}
