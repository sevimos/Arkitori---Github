...
public class FishableData {
	...
	//private static final int BARBED_HARPOON = 10129;
	...
	public static enum Fishable {
		...
		//TUNA_DRAGON(359, DRAGON_HARPOON, 35, 80.0D, -1),
		//TUNA_INFERNAL(359, INFERNAL_HARPOON, 35, 80.0D, -1),
		//TUNA_BARBED(359, BARBED_HARPOON, 35, 80.0D, -1),
		...
		//SWORD_FISH_DRAGON(371, DRAGON_HARPOON, 50, 100.0D, -1),
		//SWORD_FISH_INFERNAL(371, INFERNAL_HARPOON, 50, 100.0D, -1),
		//SWORD_FISH_BARBED(371, BARBED_HARPOON, 50, 100.0D, -1),
		...
		//SHARK_DRAGON(383, DRAGON_HARPOON, 76, 125.0D, -1),
		//SHARK_INFERNAL(383, INFERNAL_HARPOON, 76, 125.0D, -1),
		//SHARK_BARBED(383, BARBED_HARPOON, 76, 125.0D, -1),
		SEA_TURTLE(395, -1, 79, 38.0D, -1),
		MANTA_RAY(389, HARPOON, 81, 155.0D, -1),
		//MANTA_RAY_DRAGON(389, DRAGON_HARPOON, 81, 155.0D, -1),
		//MANTA_RAY_INFERNAL(389, INFERNAL_HARPOON, 81, 155.0D, -1),
		//MANTA_RAY_BARBED(389, BARBED_HARPOON, 81, 155.0D, -1),
		ANGLERFISH(13439, FISHING_ROD, 82, 195.0D, SANDWORMS),
