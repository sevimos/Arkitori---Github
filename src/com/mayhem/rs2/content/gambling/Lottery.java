...
public class Lottery {
	...
	public static void enterLotter(Player player) {
		...
		AchievementHandler.activate(player, AchievementList.ENTER_THE_LOTTERY_5_TIMES, 1);
	...
	public static void draw() {
		...
		if (winner == null) {
			...
			AchievementHandler.activate(winner, AchievementList.WIN_THE_LOTTERY_3_TMES, 1);
