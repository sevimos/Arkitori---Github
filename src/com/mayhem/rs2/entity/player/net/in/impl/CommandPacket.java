...
import com.mayhem.rs2.entity.player.net.in.command.impl.AdministratorCommand;
import com.mayhem.rs2.entity.player.net.in.command.impl.DeveloperCommand;
import com.mayhem.rs2.entity.player.net.in.command.impl.ModeratorCommand;
import com.mayhem.rs2.entity.player.net.in.command.impl.OwnerCommand;
import com.mayhem.rs2.entity.player.net.in.command.impl.PlayerCommand;
import com.mayhem.rs2.entity.player.net.in.command.impl.SupportCommands;
import com.mayhem.rs2.entity.player.net.out.impl.SendMessage;

public class CommandPacket extends IncomingPacket {

	private static final Command[] COMMANDS = new Command[] { new PlayerCommand(), new SupportCommands(), new ModeratorCommand(), new AdministratorCommand(), new DeveloperCommand(), new OwnerCommand() };
