...
public class NPCPacket extends IncomingPacket {
	...
	public void handle(Player player, StreamBuffer.InBuffer in, int opcode, int length) {
		...
		case 72:
			...
			if (mob.getId() == 4249 || mob.getId() == 3215 || mob.getId() == 1603 || mob.getId() == 2130 || mob.getId() == 2131 || mob.getId() == 2132 || mob.getId() == 155|| mob.getId() == 7042 || mob.getId() == 1847 || mob.getId() == 403 || mob.getId() == 490 || mob.getId() == 4936 || mob.getId() == 315) {
				WalkToActions.clickNpc(player, 2, slot);
				return;
			}
