...
public class ItemCheck {
	...
	public static boolean hasSlayerHelmet(Player p) {
	return (p.getEquipment().getItems()[0] != null) && (p.getEquipment().getItems()[0].getId() == 11864);
	}
	...
	public static boolean isUsingCrossbow(Player p) {
		...
		if (weapon != null) {
			int i = weapon.getId();
			return (i == 837) || (i == 21012) || (i == 4734) || (i == 9174) || (i == 9178) || (i == 9180) || (i == 9182) || (i == 9184) || (i == 9185) || (i == 21012) || (i == 11785);
		}

		return false;
	}
	
	public static boolean isUsingDragonHunter(Player p) {
		Item weapon = p.getEquipment().getItems()[3];
	...
	public static final boolean isWearingAntiDFireShield(Player p) {
		...
		if (shield != null) {
			...
			return (index == 11283) || (index == 1540) || (index == 1187);
		}
		return false;
	}
	
	public static final boolean isWearingElementalShield(Player p) {
		Item shield = p.getEquipment().getItems()[EquipmentConstants.SHIELD_SLOT];
		if (shield != null) {
			int index = shield.getId();
			return (index == 2890);
	...
	public static boolean wearingSlayerHelm(Player player) {
		int[] slots = { 0 };
		int[] ids = { 11864, 19647, 19639, 19643 };
		Item[] equip = player.getEquipment().getItems();
	...
	public static boolean wearingSlayerHelmI(Player player) {
		int[] slots = { 0 };
		int[] ids = { 11865, 19649, 19641, 19645 };
		Item[] equip = player.getEquipment().getItems();
