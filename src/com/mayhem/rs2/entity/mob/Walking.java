...
public class Walking {
	...
	public static void randomWalk(Mob mob) {
		if (mob.getId() == 1644 || mob.getId() == 1643 || mob.getId() == 7233 || mob.getId() == 1642 || mob.getId() == 1641 || mob.getId() == 1640 || mob.getId() == 1639 || mob.getId() == 1638 || mob.getId() == 1637 || mob.getId() == 1636 || mob.getId() == 1635) {
