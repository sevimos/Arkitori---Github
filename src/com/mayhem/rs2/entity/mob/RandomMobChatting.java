...
public enum RandomMobChatting {
	...
	MAKEOVER_MAGE(new int[] { 599, 2676 }, 150, "I can change your appearance.", "Welcome to the world of Mayhem"),
	COMBAT_TUTOR(new int[] { 705 }, 120, "Welcome to Mayhem!", "Become the number one pker of Mayhem!")
