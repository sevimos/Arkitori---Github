...
import com.mayhem.rs2.entity.mob.abilities.ZukAbility;
...
public class MobAbilities {
	...
	public static final void declare() {
		...
		abilities.put(Integer.valueOf(7700), new JadAbility());
		abilities.put(Integer.valueOf(7706), new ZukAbility());
